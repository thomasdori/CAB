...
function calendar(obj_target) {
	...
	this.calendarid  = calendars.length;
	calendars.push(this);
...
function cal_popup (str_datetime,localURL) {
	this.dt_current = this.prs_tsmp(str_datetime ? str_datetime : this.target.value);
	if (!this.dt_current) return;
	var url = (localURL)? 'calendar.html':SCRIPT_LIBRARY_PATH + 'calendar/calendar.html';
	var win = window.open(
		url+'?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id + '&cid=' + this.calendarid,
