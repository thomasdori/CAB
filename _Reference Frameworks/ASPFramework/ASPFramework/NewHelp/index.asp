...
<TR height="<%=Browser.ScreenHeight - 290%>">
   ...
   <TD width="*" valign="top">
	   <IFRAME style="border:dotted 1px #3366cc"  frameborder =0 Id = "PageContents" src="<%=mFrameURL%>" width='100%' height='100%' onload="document.PageContents=this"></IFRAME>
  </TD>
</TR>
<%End Function
...
'		Page.DebugEnabled=True
		If "" & Application("TVHELP") = "" Or Request.QueryString("Load")<>"" Then 
